...
export type I18nDictMap = Record<Locale, I18nDict>;

export type I18nObject = Partial<Record<Locale, string>>;
export type I18nItem = string | I18nObject;
...
export type I18nDictFallbackBase = "default" | "previous" | "none";
